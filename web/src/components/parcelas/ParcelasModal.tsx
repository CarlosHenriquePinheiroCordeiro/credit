...
type Order = "ASC" | "DESC"
type SortKeyParcela = "datavencimento" | "valorvencimento" | "totalpago" | "capitalaberto" | "createdAt"
...
export default function ParcelasModal({
  ...
  React.useEffect(() => { setPage(1) }, [contratoId])
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl">
        <DialogHeader>
          ...
          <DialogDescription>Contrato: <span className="font-medium">{contratoId ?? "-"}</span></DialogDescription>
        </DialogHeader>
