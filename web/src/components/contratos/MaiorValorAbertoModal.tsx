...
// ...imports
export default function MaiorValorAbertoModal({ open, onOpenChange }: { open: boolean; onOpenChange: (v: boolean) => void }) {
    ...
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-lg text-foreground"> {/* <-- garante contraste */}
          <DialogHeader>
            <DialogTitle className="text-foreground">Consultar período de maior valor aberto</DialogTitle>
